...
routes.post("/product", protect, UploadFiles.fields([{name:"image",maxCount:10},{name:"thumbnail",maxCount:1},{name:"video",maxCount:1}]), createProduct);
routes.patch(
  "/product/:id",
  protect,
  UploadFiles.fields([{name:"image",maxCount:10},{name:"thumbnail",maxCount:1},{name:"video",maxCount:1}]),
  updateProduct
);
